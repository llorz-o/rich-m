...
export default createComponent({
  ...
  methods: {
    // 左右滑动
    horizontalSwiper() {
      var contentContrl = new Hammer(this.$el);
    ...
    verticalSwiper() {
      ...
      var debounceEmitScrollEvent = debounce(() => this.$emit("debounceScroll", this.$el.scrollTop), 300);
    ...
    scrollToIndexPosition(index) {
      ...
      scrollTopTo(this.$el, _scrollTopDistance, .3);
    }
